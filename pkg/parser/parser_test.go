...
var realParsed = &profile{
	Entries: []*entry{
		...
		},
		{
			Param: &setVar{
				Name:  "ssh_banner",
				Value: "OpenSSH_7.4 Debian (protocol 2.0)",
			},
		},
		{
			Param: &setVar{
			...
			Group: &group{
				...
				Entries: []*entry{
					...
					},
					{
						Param: &setVar{
							Name:  "uri_x64",
							Value: "/jquery-3.3.2.slim.min.js",
						},
					},
					{
						Group: &group{
							...
							Entries: []*entry{
								{
									Func: &function{
										FuncName: "header",
										Values:   "ServerNetDNA-cache/2.2",
									},
								},
								{
									Func: &function{
										FuncName: "header",
										Values:   "Cache-Controlmax-age=0, no-cache",
									},
								},
								{
									Func: &function{
										FuncName: "header",
										Values:   "Pragmano-cache",
									},
								},
								{
									Func: &function{
										FuncName: "header",
										Values:   "Connectionkeep-alive",
									},
								},
								{
									Func: &function{
										FuncName: "header",
										Values:   "Content-Typeapplication/javascript; charset=utf-8",
									},
								},
							},
						},
							...
							Entries: []*entry{
								{
									Func: &function{
										FuncName: "header",
										Values:   "Accepttext/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
									},
								},
								{
									Func: &function{
										FuncName: "header",
										Values:   "Accept-Languageen-US,en;q=0.5",
									},
								},
								{
									Func: &function{
										FuncName: "header",
										Values:   "Refererhttp://code.jquery.com/",
									},
								},
								{
									Func: &function{
										FuncName: "header",
										Values:   "Accept-Encodinggzip, deflate",
									},
								},
							},
						},
				...
				Entries: []*entry{
					{
						Param: &setVar{
							Name:  "spawnto_x86",
							Value: "%windir%\\syswow64\\dllhost.exe",
						},
					},
					{
						Param: &setVar{
							Name:  "spawnto_x64",
							Value: "%windir%\\sysnative\\dllhost.exe",
						},
					},
					{
						Param: &setVar{
					...
					},
					{
						Param: &setVar{
							Name:  "pipename",
							Value: "Winsock2\\CatalogChangeListener-###-0,",
						},
					},
					{
						Param: &setVar{
			...
			Group: &group{
				...
				Entries: []*entry{
					...
					},
					{
						Param: &setVar{
							Name:  "rich_header",
							Value: ">\u0098þuzù\u0090&zù\u0090&zù\u0090&s\u0081\x03&üù\u0090&\x17¤\u0093'yù\u0090&zù\u0091&\u0083ý\u0090&\x17¤\u0091'eù\u0090&\x17¤\u0095'wù\u0090&\x17¤\u0094'lù\u0090&\x17¤\u009e'Vø\u0090&\x17¤o&{ù\u0090&\x17¤\u0092'{ù\u0090&Richzù\u0090&\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
						},
					},
					{
						Group: &group{
							...
							Entries: []*entry{
								...
								},
								{
									Func: &function{
										FuncName: "strrep",
										Values:   "ReflectiveLoaderexecute",
									},
								},
								{
									Func: &function{
										FuncName: "strrep",
										Values:   "This program cannot be run in DOS mode",
									},
								},
								{
									Func: &function{
							...
							Entries: []*entry{
								{
									Func: &function{
										...
										Values:   "ntdll!RtlUserThreadStart+0x42",
									},
								},
								{
									Func: &function{
				...
				Entries: []*entry{
					{
						Param: &setVar{
							Name:  "headers",
							Value: "Date, Server, Content-Length, Keep-Alive, Connection, Content-Type",
						},
					},
					{
						Func: &function{
					...
					},
					{
						Func: &function{
							FuncName: "header",
							Values:   "Keep-Alivetimeout=10, max=100",
						},
					},
					{
						Func: &function{
